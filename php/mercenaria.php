...
$sql = "SELECT id, nome, descricao FROM prestadores_servico WHERE tipo_servico = 'Marcenaria' LIMIT 3";
...
<head>
  ...
  <title>Serviços de Marcenaria</title>
...
<body>
  <div class="navbar">
    <ul class="nav justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link" href="login.html">Logar-se</a>
      </li>
      <li class="nav-item">
  ...
  <div class="container mt-5">
    <h1 class="text-center mb-4">Prestadores de Serviço - Serviços de Marcenaria</h1>
    <div class="row">
