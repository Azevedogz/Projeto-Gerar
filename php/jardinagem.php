...
$sql = "SELECT id, nome, descricao FROM prestadores_servico WHERE tipo_servico='jardinagem' LIMIT 3";
...
<body>
  ...
  <div class="container mt-5">
    <h1 class="text-center mb-4">Prestadores de Serviço - Jardinagem</h1>
    <div class="row">
