...
$sql = "SELECT id, nome, descricao FROM prestadores_servico LIMIT 3";
...
<head>
  ...
  <title>Cuidados com Animais de Estimação</title>
...
<body>
  ...
  <div class="container mt-5">
    <h1 class="text-center mb-4">Prestadores de Serviço - Cuidados com Animais de Estimação</h1>
    <div class="row">
