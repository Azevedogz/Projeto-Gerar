...
$sql = "SELECT id, nome, descricao FROM prestadores_servico WHERE tipo_servico='Reparos e Manutenção' LIMIT 3";
...
<head>
  ...
  <title>Reparos e Manutenção</title>
...
<body>
  ...
  <div class="container mt-5">
    <h1 class="text-center mb-4">Prestadores de Serviço - Reparos e Manutenção</h1>
    <div class="row">
