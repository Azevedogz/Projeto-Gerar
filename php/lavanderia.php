...
$sql = "SELECT id, nome, descricao FROM prestadores_servico WHERE tipo_servico='Lavanderia e Passadoria' LIMIT 3";
...
<head>
  ...
  <title>Lavanderia e Passadoria</title>
...
<body>
  ...
  <div class="container mt-5">
    <h1 class="text-center mb-4">Prestadores de Serviço - Lavanderia e Passadoria</h1>
    <div class="row">
