...
$sql = "SELECT id, nome, descricao FROM prestadores_servico WHERE tipo_servico = 'Mudança' LIMIT 3";
...
<head>
  ...
  <title>Serviços de Mudança</title>
...
<body>
  ...
  <div class="container mt-5">
    <h1 class="text-center mb-4">Prestadores de Serviço - Serviços de Mudança</h1>
    <div class="row">
